...
variable proj_folder
set script_root [file dirname $script_folder]
set proj_folder $script_root
...
if { $list_projs eq "" } {
   create_project iic_master ${proj_folder}/iic_master_proj -part xc7a100tcsg324-1
   set_property ip_repo_paths ${script_root}/ips [current_project]
   update_ip_catalog -rebuild -scan_changes
}

set filelist [list\
    "${script_root}/rtl/i2c_master/i2c_master_bit_ctrl.v" \
    "${script_root}/rtl/i2c_master/i2c_master_byte_ctrl.v" \
    "${script_root}/rtl/i2c_master/i2c_master_reg.v" \
    "${script_root}/rtl/i2c_master_wrapper.v" \
    "${script_root}/rtl/i2c_master/i2c_master_top.v" ]

add_files $filelist
add_files -fileset constrs_1 "${script_root}/constraint/iic_master.xdc"

create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_32
set_property -dict [list CONFIG.C_PROBE0_WIDTH {32} CONFIG.Component_Name {ila_32}] [get_ips ila_32]
...
xilinx.com:user:nexy4_ddr_7segment:*\
...
proc write_mig_file_gpio_test_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {    <ModuleName>gpio_test_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_gpio_test_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set anodes_0 [ create_bd_port -dir O -from 7 -to 0 anodes_0 ]
  set clk_in1 [ create_bd_port -dir I -type clk clk_in1 ]
  set eth_phy_rstn [ create_bd_port -dir O -type rst eth_phy_rstn ]
  ...
  write_mig_file_gpio_test_mig_7series_0_0 $str_mig_file_path
  ...
  set nexy4_ddr_7segment_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:nexy4_ddr_7segment:* nexy4_ddr_7segment_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins mdm_1/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI] [get_bd_intf_pins nexy4_ddr_7segment_0/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net intr_in_1 [get_bd_ports intr_in] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_ports sys_clk] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins nexy4_ddr_7segment_0/s00_axi_aclk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net nexy4_ddr_7segment_0_anodes [get_bd_ports anodes_0] [get_bd_pins nexy4_ddr_7segment_0/anodes]
  connect_bd_net -net nexy4_ddr_7segment_0_seg [get_bd_ports seg_0] [get_bd_pins nexy4_ddr_7segment_0/seg]
  ...
  connect_bd_net -net resetn_1 [get_bd_ports eth_phy_rstn] [get_bd_ports resetn] [get_bd_pins clk_wiz_1/resetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins nexy4_ddr_7segment_0/s00_axi_aresetn] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_reset [get_bd_ports sys_rst] [get_bd_pins rst_clk_wiz_1_100M/peripheral_reset]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs APB_M_0/Reg] 
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] 
  ...
  assign_bd_address -offset 0x41400000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs mdm_1/S_AXI/Reg] 
  assign_bd_address -offset 0x80000000 -range 0x08000000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs mig_7series_0/memmap/memaddr] 
  assign_bd_address -offset 0x80000000 -range 0x08000000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs mig_7series_0/memmap/memaddr] 
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs nexy4_ddr_7segment_0/S00_AXI/S00_AXI_reg] 
